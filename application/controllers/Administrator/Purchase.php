...
class Purchase extends CI_Controller
{
    ...
    public function damage_product_list()
    {
        ...
        $data['products'] = $this->db->query("select p.*, pc.Company_Name from tbl_product p, tbl_productcompany pc where p.Company_ID = pc.Company_SlNo and p.status = 'a' and p.is_service = 'false'")->result();
