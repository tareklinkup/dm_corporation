...
class Products extends CI_Controller
{
    ...
    public function addProduct()
    {
        ...
        try {
            ...
            $productNameCount = $this->db->query("select * from tbl_product where Product_Name = ? and Company_ID = ?", [$productObj->Product_Name, $productObj->Company_ID])->num_rows();
            ...
            $productCodeCount = $this->db->query("select * from tbl_product where Product_Code = ? and Company_ID = ?", [$productObj->Product_Code, $productObj->Company_ID])->num_rows();
    ...
    public function getProducts()
    {
        ...
        if (isset($data->companyId) && $data->companyId != '') {
            $clauses .= " and p.Company_ID = '$data->companyId'";
        }
        ...
        $products = $this->db->query("
            select
                p.*,
                concat(p.Product_Name, ' - ', p.Product_Code, ' - ', ifnull(proc.Company_Name, '')) as display_text,
