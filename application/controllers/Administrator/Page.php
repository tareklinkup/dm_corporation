...
class Page extends CI_Controller
{
    ...
    public function company_entry()
    {
        ...
        $data['content'] = $this->load->view('Administrator/company_entry', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }
    ...
    public function addCompany()
    {
        ...
        try {
            ...
            $companyCount = $this->db->query("select * from tbl_productcompany where Company_Name = ? and status = 'a'", $data->Company_Name)->num_rows();
            if ($companyCount > 0) {
                $res = ['success' => false, 'message' => 'Company Name already exists'];
            ...
            $this->db->insert('tbl_productcompany', $company);
    ...
    public function updateCompany()
    {
        ...
        try {
            ...
            $this->db->where('Company_SlNo', $companyId)->update('tbl_productcompany', $company);
    ...
    public function deleteCompany()
    {
        ...
        try {
            ...
            $this->db->where('Company_SlNo', $companyId)->update('tbl_productcompany', ['status' => 'd']);

            $res = ['success' => true, 'message' => 'Company deleted successfully'];
        } catch (Exception $ex) {
            $res = ['success' => false, 'message' => $ex->getMessage()];
        }
        echo json_encode($res);
    ...
    public function getCompanies()
    {
        ...
        if (isset($data->companyId) && $data->companyId != '') {
            $clauses .= " and pc.Company_SlNo = '$data->companyId'";
        }

        $companies = $this->db->query("
            select
                pc.*
            from tbl_productcompany pc
            where pc.status = 'a'
            $clauses
        ")->result();
