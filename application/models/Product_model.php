...
class Product_model extends CI_Model
{
	...
	{	
		...
		$this->db->select('tbl_damage.*,tbl_damagedetails.*,tbl_product.*, tbl_productcompany.Company_Name, tbl_unit.*')->from('tbl_damage');
		...
		$this->db->join('tbl_productcompany', 'tbl_productcompany.Company_SlNo = tbl_product.Company_ID', 'left');
