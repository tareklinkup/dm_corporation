                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center; font-weight:bold;">
                            {{ payments.reduce((prev,curr) => {return +prev + +parseFloat(curr.bill).toFixed(2)},0)}}
                        </td>
                        <td style="text-align:center; font-weight:bold;">
                            {{ payments.reduce((prev,curr) => {return +prev + +parseFloat(curr.paid).toFixed(2)},0)}}
                        </td>
                        <td style="text-align:center; font-weight:bold;">
                            {{ payments.reduce((prev,curr) => {return +prev + +parseFloat(curr.due).toFixed(2)},0)}}
                        </td>
                        <td style="text-align:center; font-weight:bold;">
                            {{ payments.reduce((prev,curr) => {return +prev + +parseFloat(curr.returned).toFixed(2)},0)}}
                        </td>
                        <td style="text-align:center; font-weight:bold;">
                            {{ payments.reduce((prev,curr) => {return +prev + +parseFloat(curr.paid_out).toFixed(2)},0)}}
                        </td>
                        <td style="text-align:center; font-weight:bold;">
                            {{ payments.reduce((prev,curr) => {return +prev + +parseFloat(curr.balance).toFixed(2)},0)}}
                        </td>
