		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
			<div class="col-md-6">
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<select class="form-control" v-if="companies.length == 0"></select>
						<v-select v-bind:options="companies" v-model="selectedCompany" label="Company_Name" v-if="companies.length > 0"></v-select>
					</div>
	...
	new Vue({
		...
		methods: {
			...
			saveProduct() {
				...
				this.product.Company_ID = this.selectedCompany.Company_SlNo;
			...
			editProduct(product) {
				...
				this.selectedCompany = {
					Company_SlNo: product.Company_ID,
