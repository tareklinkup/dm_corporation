						...
						<div class="col-sm-6">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<label class="col-xs-2 control-label no-padding-right"> Rate </label>
									<div class="col-xs-3">
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr>
							...
							<th style="width:31%;color:#000;">Product Name</th>
							<th style="width:15%;color:#000;">Company</th>
	...
	new Vue({
		...
		methods: {
			...
			onChangeSupplier() {
				...
				if(this.selectedSupplier.is_customer == 1) {
					axios.post('/get_customer_combine_due',{code: supplierCode}).then(res=>{
