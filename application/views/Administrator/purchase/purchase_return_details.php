				...
				<table class="record-table">
					...
					<tbody>
						<tr v-for="details in returnDetails">
							...
							<td>{{ details.Product_Code }} - {{ details.Product_Name }} -  {{ details.Company_Name }}</td>
							...
							<td>{{ details.PurchaseReturn_Description }}</td>
						</tr>
					</tbody>
					<tfoot>
						<tr style="font-weight:bold;">
							<td colspan="5" style="text-align:right;">Total</td>
							<td style="text-align:right;">{{ returnDetails.reduce((prev, curr) => { return prev + parseFloat(curr.PurchaseReturnDetails_ReturnAmount)}, 0) }}</td>
							<td></td>
						</tr>
					</tfoot>
				</table>
