    ...
    <div class="row" style="border-bottom: 1px solid #ccc;padding: 3px 0;">
        <div class="col-md-12">
            <form class="form-inline" id="searchForm" @submit.prevent="getSearchResult">
                ...
                <div class="form-group" style="display:none;"
                    v-bind:style="{display: searchType == 'company' && companies.length > 0 ? '' : 'none'}">
                    <label>Company</label>
                    ...
                    <tbody>
                        <template v-for="sale in sales">
                            <tr>
                                ...
                                <td>{{ sale.saleDetails[0].Company_Name }}</td>
                                ...
                                <td style="text-align:right;">
                                    {{ sale.saleDetails[0].SaleDetails_TotalAmount | decimal }}</td>
                                <td style="text-align:right;">{{ sale.saleDetails[0].Discount_amount }}</td>
                                <td style="text-align:right;">
                                    {{ (sale.saleDetails[0].SaleDetails_TotalAmount - sale.saleDetails[0].Discount_amount) | decimal}}
                                </td>
                            ...
                            <tr v-for="(product, sl) in sale.saleDetails.slice(1)">
                                ...
                                <td style="text-align:right;">
                                    {{ product.SaleDetails_TotalAmount - product.Discount_amount  | decimal}}</td>
                                <td></td>
                            </tr>
                            <tr style="font-weight:bold;">
                                <td colspan="10" style="font-weight:normal;"><strong>Note:
                                ...
                                <td style="text-align:right;">
                                    ...
                                    Collection: {{ sale.SaleMaster_PaidAmount }}<br>
                ...
                <template v-if="searchTypesForDetails.includes(searchType)" style="display:none;"
                    ...
                    <table class="record-table" v-if="selectedProduct == null">
                        ...
                        <tbody>
                            <template v-for="sale in sales">
                                <tr>
                                    <td colspan="4" style="text-align:center;background: #ccc;">
                                        {{ searchType == 'category' ? sale.category_name : sale.company_name }}</td>
                                </tr>
...
new Vue({
    ...
    data() {
        return {
            ...
            searchTypesForDetails: ['company', 'quantity', 'category']
        }
    },
    filters: {
        decimal(value) {
    ...
    methods: {
        ...
        getSaleDetails() {
            let filter = {
                companyId: this.selectedCompany == null || this.selectedCompany.Company_SlNo == '' ? '' :
                    this.selectedCompany.Company_SlNo,
                ...
                .then(res => {
                    ...
                    if (this.selectedProduct == null) {
                        sales = _.chain(sales)
                            ...
                            .groupBy(this.searchType == 'category' ? 'ProductCategory_ID' : 'Company_ID')
                            .map(sale => {
                                return {
                                    company_name: sale[0].Company_Name,
                                    ...
                                    products: _.chain(sale)
                                        ...
                                        .map(product => {
                                            return {
                                                ...
                                                company_name: product[0].Company_Name,
        ...
        async print() {
            ...
            let companyText = '';
            if (this.selectedCompany != null && this.selectedCompany.Company_SlNo != '' && this
                .searchType == 'company') {
                companyText = `<strong>Company: </strong> ${this.selectedCompany.Company_Name}`;
            }
            ...
            let reportContent = `
					<div class="container">
						...
						<div class="row">
							<div class="col-xs-6">
								${userText} ${customerText} ${employeeText} ${productText} ${companyText} ${categoryText}
							</div>
