	...
	<form @submit.prevent="saveCustomer">
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			...
			<div class="col-md-5">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Is Supplier:</label>
					<div class="col-md-7">
						<input type="checkbox" v-model="customer.is_supplier">
					</div>
				</div>
				...
				<datatable :columns="columns" :data="customers" :filter-by="filter" style="margin-bottom: 5px;">
					<template scope="{ row }">
						<tr>
							...
							<td>{{ row.is_supplier == 1 ? 'True' : 'False' }}</td>
							<td>
	...
	new Vue({
		...
		methods: {
			...
			editCustomer(customer) {
				...
				this.customer.is_supplier = customer.is_supplier == 1 ? true : false;
