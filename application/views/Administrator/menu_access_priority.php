        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="accounts">
                    ...
                    <li><input type="checkbox" class="access" value="customerPaymentPage" v-model="access"> Customer Collection</li>
        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="salesReports">
                    ...
                    <li><input type="checkbox" class="access" value="customerPaymentReport" v-model="access"> Customer Collection Report</li>
                    <li><input type="checkbox" class="access" value="customer_supplier_ledger" v-model="access"> Customer Supplier Ledger</li>
                    <li><input type="checkbox" class="access" value="customer_payment_history" v-model="access"> Customer Collection History</li>
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="admin">
                    ...
                    <li><input type="checkbox" class="access" value="company" v-model="access"> Company Entry</li>
